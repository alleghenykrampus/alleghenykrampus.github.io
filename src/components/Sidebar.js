	...
	render() {
		return (
			<Well>
				<h3>Follow Us</h3>
				<p>
				<a target="_blank" className="social-icon" xhref="https://www.facebook.com/ackrampus">{ fbIcon }</a>
				<a target="_blank" className="social-icon" xhref="https://twitter.com/ackrampus">{ twIcon }</a>
				</p>
			</Well>
		);
	}
